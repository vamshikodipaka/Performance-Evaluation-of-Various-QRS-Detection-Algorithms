...
%    end
   ...
   h = h - m; % substract mean to h
      plot(h,'g');   figure(4);      subplot(211), plot(prevh);    subplot(212), plot(h);
      
      prevh=h;
   h = h - m; % substract mean to h
      plot(h,'g');      figure(5);      subplot(211), plot(prevh);      subplot(212), plot(h);
         
         prevh1=h;
   h = h - m; % substract mean to h
      plot(h,'g');      figure(6);      subplot(211), plot(prevh1);      subplot(212), plot(h);
       
         prevh=h;
   h = h - m; % substract mean to h
      plot(h,'g');      figure(7);      subplot(211), plot(prevh);      subplot(212), plot(h);  
      
%          prevh=h;
%    h = h - m; % substract mean to h
%       plot(h,'g');      figure(8);      subplot(211), plot(prevh);      subplot(212), plot(h);
%      
%          prevh=h;
%       h = h - m; % substract mean to h
%       plot(h,'g');      figure(9);      subplot(211), plot(prevh);      subplot(212), plot(h); 
%       
%          prevh=h;
%       h = h - m; % substract mean to h
%       plot(h,'g');      figure(10);      subplot(211), plot(prevh);      subplot(212), plot(h);
%       
%          prevh=h;
%       h = h - m; % substract mean to h
%       plot(h,'g');      figure(11);      subplot(211), plot(prevh);      subplot(212), plot(h);
%       
%          prevh2=h;
%       h = h - m; % substract mean to h
%       plot(h,'g');      figure(12);      subplot(211), plot(prevh2);      subplot(212), plot(h);
%       
%       
